...
data_params_config = {
    "featurisation": ["mtencoder_512", "mtencoder_256", "matminer", "composition", "matscibert"],
    "use_only_target": [False], #[False, True]
    "model_type": ["GNN", "NN"], #["NN", "XGB", "GNN"]
    "task": ["sint"] #["calc", "sint"]
}
...
data_path = "/home/students/code/MLP/Menelaos/reaction_conditions/dataprocessing_MTE/dataset_v4"
...
for data_params in data_pamams_grid:
    ...
    if model_type == "NN" or model_type == "XGB":
        for pooling_param in pooling_params_grid:
            ...
            print(f'Configuartion: {data_params}')
            results_logger['params'] = data_params
            ...
            for split in range(5):
                ...
                if model_type == "NN":
                    ...
                    results_logger['train_maes'].append(train_mae)
                    results_logger['val_maes'].append(val_mae)
                    results_logger['test_maes'].append(test_mae)
    ...
    """json_serializable_test_outputs = [output.item() if hasattr(output, 'item') else output for output in test_outputs]
    json_serializable_test_truth = [truth.item() if hasattr(truth, 'item') else truth for truth in test_truth]
    results_logger['predictions'].append((json_serializable_test_outputs, json_serializable_test_truth))"""
